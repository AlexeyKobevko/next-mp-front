...
const getVacancyById = async (id: string): Promise<Vacancy | null> => {
	...
	const demoVacancy: Vacancy = {
		...
		type: 'hybrid',
		tags: ['React', 'Next.js', 'TypeScript', 'TailwindCSS', 'Zustand', 'Redux', 'GraphQL'],
		description:
				...
				<div className="grid gap-8 lg:grid-cols-3">
							...
							<div className="flex items-start justify-between gap-4">
								<div className="flex-1">
									{vacancy.popular && (
										<div
											className={cn(
												'inline-flex items-center gap-1 mb-3 rounded-full px-3 py-1 text-xs font-bold',
									...
									<div className="flex items-center gap-2">
										<BuildingOfficeIcon className="text-dark-accent dark:text-light-accent h-6 w-6" />
										<span className="text-xl text-dark-shades/80 dark:text-light-shades/80">
											{vacancy.company}
										</span>
									</div>
								</div>
					...
					<aside className="lg:col-span-1">
						...
						>
							...
							{/* Меню действий */}
							<div className="border-t border-dark-accent/10 dark:border-light-accent/10 pt-4">
								<Menu as="div" className="relative">
									...
									>
										<MenuItems
											className={cn(
												'absolute left-0 right-0 z-20 mt-2 origin-top rounded-lg shadow-lg',
												'bg-light-shades dark:bg-dark-shades',
